...
public class LBarChartView extends FrameLayout {
    ...
    public LBarChartView( Context context,  AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public LBarChartView( Context context,  AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public LBarChartView( Context context,  AttributeSet attrs, int defStyleAttr, int defStyleRes) {
