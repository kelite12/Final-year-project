...
class BaiduActivity : BaseActivity(),OnGetRoutePlanResultListener, OnGetGeoCoderResultListener {
    ...
    override fun onGetDrivingRouteResult(result: DrivingRouteResult?) {
        ...
        if (result.error == SearchResult.ERRORNO.NO_ERROR) {
            ...
            if (false) {
                ...
                if (!hasShownDialogue) {
                    val myTransitDlg = MyTransitDlg(this, result.getRouteLines(), RouteLineAdapter.Type.DRIVING_ROUTE)
                    myTransitDlg.setOnDismissListener(DialogInterface.OnDismissListener { hasShownDialogue = false })
                    myTransitDlg.setOnItemInDlgClickLinster(object :
                        BaiduActivity.OnItemInDlgClickListener {
