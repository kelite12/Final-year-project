package com.ztkj.victe.ui.step.step.service;
...
import com.ztkj.victe.ui.step.step.accelerometer.StepCount;
import com.ztkj.victe.ui.step.step.accelerometer.StepValuePassListener;
...
//            Logger.d("tempStep" + tempStep);
    ...
    private void save() {
        ...
        if (list.size() == 0 || list.isEmpty()) {
            ...
            data.setWeight(MyApplication.user.getWeight()+"");
